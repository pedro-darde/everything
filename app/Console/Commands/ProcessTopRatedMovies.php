...
class ProcessTopRatedMovies extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:process-top-rated-movies';
    ...
    {
        $this->info('Processing top rated movies');

        $result = $service->searchTopRated(4);

        try {
            TopRatedMovies::query()->truncate();
            DB::beginTransaction();
